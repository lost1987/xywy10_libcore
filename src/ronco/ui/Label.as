package ronco.ui
{
	...
	{
		// 文本其他属性 则通过 label 设置.
		public var label:fl.controls.Label = new fl.controls.Label();
		private var format:TextFormat = new TextFormat("宋体", 13, 0xffffff);
		...
		public function Label(_name:String, _parent:UIElement)
		{
			super(UIDef.UI_LABEL,_name, _parent);
