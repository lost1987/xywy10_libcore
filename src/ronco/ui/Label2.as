package ronco.ui
{
	...
	public class Label2 extends UIElement
	{
		// 文本其他属性 则通过 label 设置.
		
		private var label:fl.controls.Label = new fl.controls.Label();
		private var format:TextFormat = new TextFormat(null, 13, 0xffffff);
		...
		public function Label2(_name:String, _parent:UIElement)
		{
