package ronco.ui
{
	...
	public class TextEx extends UIElement
	{
		// 文本其他属性 则通过 label 设置.
		...
		public function TextEx(_name:String, _parent:UIElement)
		{
			super(UIDef.UI_TEXTEX,_name, _parent);
			
			// zhs007 @ 2010.12.22
			// 必须要初始化的变量，直接放到变量队列中初始化
			//			label = new fl.controls.Label();
			//			format = new TextFormat(null,12,0xffffff);
		}
		...
		public function bEdit(_b:Boolean):void
		{
			if(_b)
			{
		...
		public function init(_s:String, _fontsize:int = 12, _autosize:String = flash.text.TextFieldAutoSize.LEFT):void
		{
			label.htmlText = _s;
...
//			label.selectable = false;
		...
		public function setAlign(align:String = flash.text.TextFieldAutoSize.LEFT):void
		{
...
//		}
		...
		{
			label.width = _w;
			label.height = _h;//setSize(_w,_h);//自动识别显示全部文本
