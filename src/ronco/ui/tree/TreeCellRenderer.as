package ronco.ui.tree {
	...
	public class TreeCellRenderer extends Sprite {
		...
		public function TreeCellRenderer(t:Tree) {
			super();
			
			tree = t;
			openIcon = new Bitmap(tree.iconOpen.bitmapData);
			closeIcon = new Bitmap(tree.iconClose.bitmapData);
			bg = new Bitmap(tree.imgSelected.bitmapData);
...
//			this.bg.graphics.endFill();
		...
		protected function setMouseArea(_x:Number, w:Number):void {
			...
			this.mouseArea.graphics.beginFill(0xffffff, 0);
		...
		protected function setMouseOverBg():void {
			...
			bg.alpha = 0.2;
//			this.bg.graphics.clear();
//			this.bg.graphics.beginFill(0xffffff, .2);
...
//			this.bg.graphics.endFill();
		...
		protected function setSelectedBg():void {
			...
			bg.alpha = 1.0;
//			this.bg.graphics.clear();
//			this.bg.graphics.beginFill(0xffff00, .6);
//			this.bg.graphics.drawRect(_maskX, 0, this._maxMaskX, _maskHeight);
//			this.bg.graphics.endFill();
		}
		...
		protected function setOpenIcon():void {
			//这里请在子类中重写自己设定即可
			ronco.base.Base.safeRemoveChild(this, closeIcon);
			icon = openIcon;
		}
		...
		protected function setCloseIcon():void {
			//这里请在子类中重写自己设定即可
			ronco.base.Base.safeRemoveChild(this, openIcon);
			icon = closeIcon;
		}
...
//			
//			if (this._hasChildNodes) {
//				iconGrap.beginFill(0xffffff, 0.8);
//			} else {
