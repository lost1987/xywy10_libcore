...
package ronco.ui.GIFPlayer.gif.player
{	
	...
	import ronco.ui.GIFPlayer.gif.decoder.GIFDecoder;
	import ronco.ui.GIFPlayer.gif.events.GIFPlayerEvent;
	import ronco.ui.GIFPlayer.gif.events.FrameEvent;
	import ronco.ui.GIFPlayer.gif.events.TimeoutEvent;
	import ronco.ui.GIFPlayer.gif.events.FileTypeEvent;
	import ronco.ui.GIFPlayer.gif.errors.FileTypeError;
	...
	public class GIFPlayer extends Bitmap
	{
		...
		public function loadFromMem(pBytes:ByteArray):void
		{
			readStream(pBytes);
		}
